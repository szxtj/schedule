...
class AppConstants {
  static const String appName = '计划攻克清单';

  // 默认子任务预估时间（分钟）
  static const int defaultEstimatedMinutes = 25;

  // 预估时间快捷推荐（分钟）
  static const List<int> quickMinutesPresets = [5, 10, 15, 25, 30, 45, 60, 90, 120];
...
class AppColors {
  ...
  static const Color accent = Color(0xFF10B981);       // Emerald Green (Focus/Success)
